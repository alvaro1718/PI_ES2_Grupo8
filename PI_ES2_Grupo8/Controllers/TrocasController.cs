...
namespace PI_ES2_Grupo8.Controllers
{
    public class TrocasController : Controller
    {
        ...
        {
            var servicoDomicilioDbContext = _context.Troca.Include(t => t.Enfermeiros).Include(t => t.gerarHorarios);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["gerarHorariosId"] = new SelectList(_context.Set<gerarHorarios>(), "gerarHorariosId", "gerarHorariosId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("TrocaId,justificacao,EnfermeirosId,gerarHorariosId")] Troca troca)
        {
            ...
            ViewData["gerarHorariosId"] = new SelectList(_context.Set<gerarHorarios>(), "gerarHorariosId", "gerarHorariosId", troca.gerarHorariosId);
            return View(troca);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TrocaId,justificacao,EnfermeirosId,gerarHorariosId")] Troca troca)
        {
            if (id != troca.TrocaId)
            {
                return NotFound();
